...
public class Packet {
    ...
    public String toString() {
        ...
        sb.append(", payloadSize=").append(ip4Header.totalLength - (ip4Header.headerLength + tcpHeader.headerLength));
        sb.append('}');
        return sb.toString();
    }
    ...
    public void updateTCPBuffer(ByteBuffer buffer, byte flags, long sequenceNum, long ackNum, int payloadSize) {
        ...
        backingBuffer.put(IP4_HEADER_SIZE + 13, flags); // запись флагов в заголов TCP, поэтому + 13
