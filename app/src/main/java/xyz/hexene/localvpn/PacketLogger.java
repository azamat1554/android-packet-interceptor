...
public class PacketLogger extends Application {
    ...
    private static SparseArray<String> installedAppsInfo;
    ...
    public void onCreate() {
        ...
        installedAppsInfo = initializeInstalledApps();
    }

    private SparseArray<String> initializeInstalledApps() {
        SparseArray<String> installedAppsInfo = new SparseArray<>();
        PackageManager packageManager = getApplicationContext().getPackageManager();
        List<ApplicationInfo> packages = packageManager.getInstalledApplications(PackageManager.GET_META_DATA);

        for (ApplicationInfo applicationInfo : packages) {
            String appName = packageManager.getApplicationLabel(applicationInfo).toString();
            installedAppsInfo.put(applicationInfo.uid, appName);
